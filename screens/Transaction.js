...
export default class TransactionScreen extends Component {
  ...
  handleTransaction = async () => {
   ...
   var transactionType = await this.checkBookAvaiilability (bookId);
if (!transactionType) {
  this.setState({bookId: "", studentId: ""}):
  // solo para usarlo Android
  // ToastAndroid.show("El libro no se encuentra en la base de datos de la biblioteca");
  Alert.alert("El libro no se encuentra en la base de datos de la bibliotecac");
}
